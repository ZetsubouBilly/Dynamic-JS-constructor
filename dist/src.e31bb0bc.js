  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHTML() {
      var _this$options = this.options,
          ...
          styles = _this$options.styles; // const tag = block.options.tag ?? 'h1';  //если отсутствует  block.options.tag то по умолчанию ставится h1
...
var App = /*#__PURE__*/function () {
  ...
  _createClass(App, [{
    ...
    value: function init() {
      ...
      var site = new _site.Site('#site'); // доллар означает dom-элемент
...
var text = "Osmanthus wine tastes the same as I remember... But where are those who share the memory?";
var model = [new _blocks.TitleBlock('Конструктор сайтов на JS', {
  ...
  alt: "This is image"
}), new _blocks.ColumnsBlock(['Приложение на чистом JS, без использования библиотек', 'Здесь могут сбываться мечты', 'Или не могут, все зависит от тебя'], {
  styles: {
